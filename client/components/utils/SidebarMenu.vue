...
<template>
    <div class="drawer z-50 w-12 mx-2">
        ...
        <div class="drawer-side z-50">
            ...
            <ul
                class="flex items-center menu h-screen overflow-y-auto w-80 bg-base-100 text-base-content mb-1"
            >
                ...
                <li>
                    <button
                        class="btn btn-wide btn-secondary mb-16 pt-4"
                ...
                <li>
                    <extensionsSidebarNuxtLink
                        to="/"
                        class="btn btn-wide mb-1 btn-ghost pt-4"
                        @click="closeSidebar()"
                        >Dashboard</extensionsSidebarNuxtLink
                    >
                </li>
                <li>
                    <extensionsSidebarNuxtLink
                        to="/tech"
                        class="btn-ghost btn btn-wide pt-4 mb-1"
                        @click="closeSidebar()"
                    >
                        Techstack
                    </extensionsSidebarNuxtLink>
                ...
                <li>
                    <extensionsSidebarNuxtLink
                        to="/settings"
                        class="btn-ghost btn btn-wide pt-4 mt-12"
                        @click="closeSidebar()"
                    >
                        Settings
                    </extensionsSidebarNuxtLink>
